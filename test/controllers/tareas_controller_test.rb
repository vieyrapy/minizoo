...
class TareasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tarea" do
    assert_difference('Tarea.count') do
      post tareas_url, params: { tarea: { fecha: @tarea.fecha, terminado: @tarea.terminado } }
    end
  ...
  test "should update tarea" do
    patch tarea_url(@tarea), params: { tarea: { fecha: @tarea.fecha, terminado: @tarea.terminado } }
